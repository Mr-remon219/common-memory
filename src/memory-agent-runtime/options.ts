import { requireInteger } from './endpoint.js';
export type RemoteApi = 'responses' | 'chat_completions';
export const REASONING_EFFORTS = ['none','minimal','low','medium','high','xhigh','max'] as const;
export type ReasoningEffort = typeof REASONING_EFFORTS[number];
export interface RemoteTuning { maxOutputTokens?: number | null; maxAgentTurns?: number; reasoningEffort?: ReasoningEffort; thinking?: {type:'enabled' | 'disabled'}; enableThinking?: boolean }
